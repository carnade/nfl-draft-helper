...
function LeftMenu({ userName, setUserName }) {
  ...
  const MANUAL_LAST_UPDATED = "2026-05-25T00:00:00.000Z";
  ...
  return (
    <div className={`left-menu ${isCollapsed ? "collapsed" : ""}`}>
      ...
      <ul className="menu-links">
        ...
        <li>
          <Link to="/odds" className="menu-link">
            <FontAwesomeIcon icon={faScaleBalanced} className="menu-icon" />
            <span>Odds</span>
          </Link>
        </li>
        <li>
          <Link to="/tournaments" className="menu-link">
