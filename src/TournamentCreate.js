...
function TournamentCreate() {
  ...
  // Generate participant structures when participantCount changes (only in step 2)
  useEffect(() => {
    if (step === 2) {
      ...
      <form onSubmit={handleSubmit} className="tournament-create-form">
        ...
        {step === 1 ? (
          ...
          <>
            ...
            <div className="tournament-form-section">
              <label className="tournament-form-label">Matchups</label>
